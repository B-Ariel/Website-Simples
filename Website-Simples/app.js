//Tem o intuito de mostrar funcionalidades, por isso que a aparência é "bem simples" (brega)

'use strict'

alert("Tem o intuito de mostrar funcionalidades, por isso que a aparência é \"bem simples\" (brega)");
